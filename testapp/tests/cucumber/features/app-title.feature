Feature: App title should be correct

  As a user
  I want to click a button and have the last action undo
  So that I can undo actions
  ...
  Scenario: This scenario will run on both dev and CI
    When I navigate to "/"
    Then I should see the title "Test App for babrahams:undo-redo package"
